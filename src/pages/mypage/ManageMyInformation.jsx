    ...
    <>
      <DefaultLayout>
        ...
        <div className='flex flex-col items-center'>
          ...
          {isOpen && (
          <div className="flex flex-col justify-center gap-8 h-[35rem] w-5/6 px-40 py-24" style={{ backgroundColor: '#F4F7FC' }}>
            ...
            <div className='flex justify-center items-center'>
              ...
              <div className="flex justify-start items-center px-4 py-3 ml-[5.5rem] mr-[2.4rem] bg-[#f2f4f8] border-b border-l-0 border-[#c1c7cd]">
                <p className="flex-grow w-[329px] text-base text-[#697077]">서울시 성북구 동소문로 ********</p>
              </div>
              <div className="flex justify-center items-center w-[3.875rem] h-[2.813rem] rounded-[8.16px] bg-white border-[0.82px] border-black">
                <p className="text-lg">
                  변경
            ...
            <div className='flex justify-center items-center'>
              ...
              <div className="flex justify-start items-center px-4 py-3 ml-[4.125rem] mr-[2.4rem] bg-[#f2f4f8] border-b border-l-0 border-[#c1c7cd]">
                <p className="flex-grow w-[329px] text-base text-[#697077]">ch*******n76@naver.com</p>
              </div>
              <div className="flex justify-center items-center w-[3.875rem] h-[2.813rem] rounded-[8.16px] bg-white border-[0.82px] border-black">
                <p className="text-lg">
                  변경
          ...
          {passwordOpen && (
          <div className="flex flex-col justify-center items-center gap-8 h-[35rem] w-5/6 px-40 py-20" style={{ backgroundColor: '#F4F7FC' }}>
