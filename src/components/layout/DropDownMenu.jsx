        ...
        <>
            ...
            >
                ...
                <div className='flex justify-center p-3 gap-4'>
                    ...
                    <Link to="/profile" className="flex items-center text-3xl text-left">카드관리</Link>
                </div>
                <div className='flex justify-center p-3 gap-4'>
                    <img src={HelpIcon} alt="Help Icon" />
                    <Link to="/help" className="flex items-center text-3xl text-left">문의하기</Link>
                </div>
                <div className='flex justify-center p-3 gap-4'>
                    <img src={LogoutIcon} alt="Logout Icon" />
                    <Link to="/logout" className="flex items-center text-3xl text-left">로그아웃</Link>
                </div>
            </div>
        </>
    );
